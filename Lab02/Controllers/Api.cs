...
namespace Lab02.Controllers
{
    ...
    public class Api : ControllerBase
    {
            ...
            try
            {
                if (file != null)
                {
                    ...
                    using (FileStream fileStream = System.IO.File.Create(_environment.WebRootPath + "\\Upload\\" + file.FileName))
                    {
                        ...
                        MemoryStream enviar= new MemoryStream(System.IO.File.ReadAllBytes(_environment.WebRootPath + "\\Upload\\" + Path.GetFileNameWithoutExtension(file.FileName) + ".huff"));
        ...
        {
            return Informacion.Instance.informacion.Select(x => new Json { nombreArchivo=ArchivOriginal,ubicacionComprimido=UbicacionCom,
